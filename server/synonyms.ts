...
export const SYNONYM_GROUPS: string[][] = [
  ...
  ['transit', 'bus', 'brt', 'rapid transit', 'public transit', 'ltc', 'london transit', 'london transit commission', 'bus route', 'bus stop', 'transit hub', 'public transportation', 'mass transit', 'transit pass', 'transit card', 'shift', 'east london link', 'wellington gateway'],
  // Parking variants
  ...
  ['homeless', 'homelessness', 'unhoused', 'houseless', 'experiencing homelessness', 'people experiencing homelessness', 'shelter', 'encampment', 'tent city', 'rough sleeping', 'unsheltered', 'centre of hope', 'salvation army', 'hub', 'wcsr', 'whole of community system response'],
  ...
  ['pool', 'pools', 'swimming pool', 'swimming', 'aquatic', 'aquatics', 'splash pad', 'arena', 'arenas', 'ice rink', 'rink', 'skating', 'murc', 'multi-use recreation complex', 'multi-use recreational complex'],
  // Sports variants
