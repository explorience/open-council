...
The site is built by volunteers at the [Institute for Community Sustainability](https://communitysustainability.ca/) and is completely free to use.

---

## Getting Around the Site

When you first visit [opencouncil.xyz](https://opencouncil.xyz), you'll see the homepage with:
...
1. Click the **chat icon** in the bottom-right corner (or use the chat box on the homepage)
...
3. The chatbot searches through meeting transcripts, minutes, motions, and vote records to find the answer
4. It will cite which meeting and date the information came from
...
1. **Meeting title and date** — which committee met and when
2. **Link to eScribe** — takes you to the city's official minutes on their website
3. **Full transcript** (when available) — the complete word-for-word record of what was said, inside a collapsible section. Click "View full transcript" to expand it
4. **Votes section** — a list of every substantive vote that happened at the meeting
...
The **Vote Explorer** at [opencouncil.xyz/votes](https://opencouncil.xyz/votes) is a searchable, filterable list of every substantive vote since 2011.
...
Each councillor has a detailed profile page. Find them at [opencouncil.xyz/councillors](https://opencouncil.xyz/councillors).
...
Visit [opencouncil.xyz/councillors](https://opencouncil.xyz/councillors) (the index page) to see all councillors ranked by:
...
Visit [opencouncil.xyz/councillors/alignment](https://opencouncil.xyz/councillors/alignment) for an interactive heatmap showing how often every pair of councillors votes together.
...
Click the **eye icon** (👁) on any page — a meeting, a committee, a councillor — to add it to your personal watchlist. Visit [opencouncil.xyz/watchlist](https://opencouncil.xyz/watchlist) to see everything you're tracking.
...
Visit [opencouncil.xyz/alerts](https://opencouncil.xyz/alerts) to see recent activity on items you're watching. When new meetings happen or votes are recorded on topics you care about, they'll show up here.
...
1. **Start with the chatbot** — if you have a question, just ask. It's the fastest way to find information.

2. **Use the Vote Explorer for research** — searching "homelessness" in the Vote Explorer shows you every vote council has taken on homelessness, who voted which way, and whether it passed.

3. **Check your councillor's page before election time** — their attendance rate, voting record, and alignment with other councillors tells you a lot about how they actually govern (not just what they say).

4. **Look at the alignment matrix** — it reveals the real power dynamics on council. Who votes together? Who's the outlier? This context helps you understand why certain votes go the way they do.

5. **Filter for close votes** — in the Vote Explorer, select "Close Votes (≤3 margin)" to see only the decisions that could have gone either way. These are the ones where your councillor's vote truly mattered.

6. **Follow contested votes, not unanimous ones** — unanimous 15-0 votes are usually routine. The real stories are in the 8-7 and 9-6 splits.

7. **Check the "Notable Dissenting Votes" section** on councillor pages — it shows where they took a stand that didn't win, which often reveals their actual priorities.
...
- **Meeting minutes and agendas** — scraped from London's [eScribe system](https://pub-london.escribemeetings.com/)
- **Transcripts** — automated speech-to-text recordings from [Lillian Skinner's London Council Archive](https://london.lillianskinner.ca)
...
*Open Council is a project of the [Institute for Community Sustainability](https://communitysustainability.ca/). The code is open source and available on [GitHub](https://github.com/explorience/open-council).*
