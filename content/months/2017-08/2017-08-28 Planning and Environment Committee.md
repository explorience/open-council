...
[Original link](https://pub-london.escribemeetings.com/Meeting.aspx?Id=bbf3a411-7f2b-47f5-8cc3-3b41fd150a95&Agenda=PostMinutes&lang=English)

> [!abstract]- Present:
> S. Turner (Acting Chair), M. Brown, M. Cassidy, J. Helmer, A. Hopkins, H. Lysynski (Secretary)
...
That it BE NOTED that Councillor S. Turner
  ...
  having to do with the Review
  of Impacts from Industrial Sources (Focus on Odour) and Potential Municipal
  Actions (Primarily South of Highway 401) and the communications dated August
  11, 2017 and July 28, 2017, respectively from J. Pastorius, Manager, Old East
  Village BIA and J. MacDonald, CEO and General Manager, Downtown London, by indicating that
...
b)         the
  ...
  Report appended to the staff report dated August 28, 2017 as Appendix ‘B’.   (2017-L04A)
...
 
a)         the
  proposed by-law appended to the staff report dated August 28, 2017 BE
  ...
  change the zoning FROM a Holding Residential R1 (h-52*h-100*R1-3) Zone, a
  Holding Residential R1 (h-52*h-100*R1-5) Zone and a Holding Residential R1
...
That, consideration for entering into a
...
That, on
  the recommendation of the Senior Planner, Development Services, based on the
  application by Sifton Properties Limited, relating to lands located at 2810 Sheffield
  Place, described as Block 60 Registered Plan 33M-672, the proposed by-law
  appended to the staff report dated August 28, 2017 BE INTRODUCED at the
  ...
  the lands FROM a Holding Residential R6 Special Provision (h-h-100-R6-2(11))
  Zone TO a Residential R6
  Special Provision (R6-2(11)) Zone to remove the holding (h &
  h-100) provisions.   (2017-D07)
...
a)         the
  ...
  Callingham Drive, an extension of Pelkey Road and three (3) new local
  streets:
 
i)          the
...
b)           
  ...
  subject lands FROM a Multi-Family, Medium Density Residential designation which
  allows townhouses and various forms of cluster housing at a maximum density
  of 75 units per hectare TO a Community Commercial Node designation to
  ...
  maximum gross floor area of 16,778 m2 (180,600 ft2) BE
...
c)           
  ...
  Area Special Provision (CSA4 (_)) Zone, to permit various retail and
  commercial uses with a 20,000 square metre maximum gross floor area, a 0
  metre minimum front and exterior side yard setback, a 15 metre maximum height
  and 1 parking space per 30m2 for all uses excluding office uses BE
...
iii)         (h-53) to encourage street-oriented
  ...
  designed and approved, consistent with the Community Plan, to the satisfaction
...
f)            
  the
  Ontario Municipal Board BE REQUESTED to advise the applicant that the
  Director, Development Finance, has summarized claims and revenues information
  appended to the staff report dated August 28, 2017 as Appendix "B";
  and,
 
g)           
  the
...
-                    
  a
  communication dated August 24, 2017 from M. Bassani, Stikeman Elliott.   (2017-D12/D09)
...
Motion
  to review and receive the requests for delegation status.
...
Motion to refer the matter to allow a
  future public participation meeting to allow all parties an opportunity to
...
 
it
  being noted that the London Advisory Committee on Heritage does not oppose
  the demolition of the buildings located at 36 and 40 York Street, but noted
  the following with respect to the proposed development at the site:
 
 
A)          
...
 
it
  being further noted that the London Advisory Committee on Heritage received
...
b)           
  ...
  the subject lands FROM an Open Space (OS4) Zone and a Holding Open Space (h-2-OS4)
  Zone and an Environmental Review (ER) Zone and an Agricultural (AG1) Zone TO
  an Open Space Special Provision (OS2(*)) Zone and an Open Space (OS5) Zone
  and a Holding Open Space Special Provision (h-18-OS5(*)) Zone and an Open
  Space (OS5(**)) Zone and a Holding Agricultural Special Provision (h-18-AG1(*))
  Zone;
 
...
That, on
  ...
  actions be taken with respect to the application of Sifton Properties Limited
  relating to the lands located at 2810 Sheffield Place:
 
a)           
  the Approval Authority BE ADVISED
  that issues were raised at the public meeting with respect to the application
  for Draft Plan of Vacant Land Condominium relating to the property located at
  2810 Sheffield Place relating to the height of the proposed buildings; and,
 
b)           
  the Approval Authority BE ADVISED that issues
  were raised at the public meeting with respect to the Site Plan Approval application
...
b)         the
  ...
  the “Primary Collector” street classification over lands located west of Hamilton
  Road and north of Commissioners Road East (identified as Street ‘C’ in Draft
  Plan of Subdivision File No. 39T-13502) in Section 4.21 Road Allowance
  Requirements – Specific Roads; and,
 
c)         the
...
vii)       ensure
  ...
  from York Street;
viii)        
  include a combination of low masonry walls (up to a maximum
  of 0.75m in height) and landscaping along the York Street frontage (west of
  the drive isle) where parking is visible from the street in order to screen
  this function and to establish a built edge along the street; and,
ix)          
  include
...
-                    
  ...
  implement, the Auto-Oriented Commercial Corridor policies of the City of
  London Official; and,
-                    
  the
...
 
d)         a
  City of London webpage BE CREATED for the purpose of making available local MOECC
  public information and statistics dealing with odours and related matters
  from selected waste management and industrial facilities in south London, for
  a two-year period;
 
 
 
...
 
i)          the source of funding for the
  Pilot Project noted in h), above, BE APPROVED at a cost of $20,000
  from the Sanitary Landfill Site Reserve Fund; it being noted that the draw
  from the Reserve Fund may not be required should the service area generate a
  surplus position at year end;
 
j)          City
  of London procurement and contract management processes BE             ENHANCED
to include specific requirements addressing odours and             other considerations
  for processing food and organic waste;
 
...
> |M. Cassidy|
> |J. Helmer|
> |A. Hopkins (4) RECUSED: S. Turner (1)|
...
That, on the recommendation of the Managing
  ...
  the Downtown Heritage Conservation District pursuant to Section 42(1) of the Ontario
...
it being noted that no individuals spoke at
  the public participation meeting associated with this matter.   (2017-P10D-R01)
...
-                    
  a
  communication from D. MacRae, 2129 Wateroak Drive;
-                    
  a
  communication from The Comrie Family, 2015 Foxwood Avenue;
-                    
  a
...
-                    
  a
  communication dated August 24, 2017, from P. Smith, 1131 Lawson Road;
-                    
  a
  communication from K. Manson, by e-mail;
-                    
  a
  communication from J. and R. Black, 2100 Denview Avenue;
-                    
  a
  communication from S. Beaumont, by e-mail;
-                    
  a
  communication from N. Spearing, Board of MVLCC 611;
-                    
  a
  communication from the DiCarolos, by e-mail;
-                    
  a
  communication from G. and C. Daubs, 1036 Aldersbrook Road;
-                    
  a
  communication from A. Hall, 360 Rivertrace Close; and,
-                   
  a
  communication from J. and K. Rouselle.    (2017-P01)
...
a)           
  the
  following actions be taken with respect to tree planting under hydro lines: 
 
i)          the
...
 
“iii)        a working
  group of appropriate stakeholders including members of the Trees and Forests
  Advisory Committee BE ESTABLISHED to review and report back with respect to
...
The Planning and Environment Committee
  convened in camera from 4:15 PM to 4:32 PM and from 7:19 PM to 7:23 PM after
  having passed motions to do so, with respect to the following matters: 
 
C-1.     A matter pertaining
  to advice
  ...
  municipality in connection with complaints about the operation of a
  composting facility near the Shaver-Brockley community and surrounding area
  and to litigation or potential litigation with respect to potential remedies
...
 
C-2.     (ADDED) 
  A matter pertaining to legal advice that is subject to solicitor-client
  privilege, including communications necessary for that purpose in connection
  with the application by Barvest Realty Inc. relating to the property located
  at 58 Sunningdale Road West.

The meeting adjourned at 1:51 AM.

---

## Votes

*26 substantive votes at this meeting (26 contested, 0 unanimous). Procedural motions excluded.*
...
**Yea (2):** [Maureen Cassidy](/councillors/current/m-cassidy), [Matt Brown](/councillors/current/m-brown)
...
**Yea (9):** [Jesse Helmer](/councillors/current/j-helmer), [Jesse Helmer](/councillors/current/j-helmer), [Jesse Helmer](/councillors/current/j-helmer), [Maureen Cassidy](/councillors/current/m-cassidy), [Maureen Cassidy](/councillors/current/m-cassidy), [Maureen Cassidy](/councillors/current/m-cassidy), [Matt Brown](/councillors/current/m-brown), [Matt Brown](/councillors/current/m-brown), [Matt Brown](/councillors/current/m-brown)
...
**Yea (14):** [Anna Hopkins](/councillors/current/a-hopkins), [Anna Hopkins](/councillors/current/a-hopkins), [Jesse Helmer](/councillors/current/j-helmer), [Jesse Helmer](/councillors/current/j-helmer), [Jesse Helmer](/councillors/current/j-helmer), [Maureen Cassidy](/councillors/current/m-cassidy), [Maureen Cassidy](/councillors/current/m-cassidy), [Maureen Cassidy](/councillors/current/m-cassidy), [Stephen Turner](/councillors/current/s-turner), [Stephen Turner](/councillors/current/s-turner), [Stephen Turner](/councillors/current/s-turner), [Matt Brown](/councillors/current/m-brown), [Matt Brown](/councillors/current/m-brown), [Matt Brown](/councillors/current/m-brown)
...
**Yea (3):** [Jesse Helmer](/councillors/current/j-helmer), [Maureen Cassidy](/councillors/current/m-cassidy), [Matt Brown](/councillors/current/m-brown)
