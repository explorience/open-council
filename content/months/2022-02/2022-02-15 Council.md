...
*19 substantive votes at this meeting (6 contested, 13 unanimous). Procedural motions excluded.*
...
> That on the recommendation of the City Manager, the following action be taken with respect to ending Islamophobia in London: a) the report of the Anti-Islamophobia Working Group, A London for Everyone: An Action Plan to Disrupt Islamophobia (Action Plan), attached to the staff report dated Februa...
...
> That all of clause 4.9 BE APPROVED, excluding:    a) i) a) ii) a) vi) That the following actions be taken with respect to the 7th Report of the Governance Working Group from its meeting held on January 17, 2022: a)  based on the results of the Council-directed Advisory Committee Member consultati...
