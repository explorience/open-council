...
These are the issues where council has actually split since 2023 — where a vote wasn't unanimous, and wasn't purely procedural. 1,149 additional divided motions since 2023 were independently classified as not fitting any of these tracked issue clusters, and are not force-fit into one; all of them are listed on the [issues page](/election/issues).

- [Housing & Density](/election/issues/housing) — 212 divided votes since 2023, 126 with a clear direction
- [Taxes & Budget](/election/issues/budget) — 113 divided votes since 2023, 84 with a clear direction
- [Homelessness & Encampments](/election/issues/encampments) — 112 divided votes since 2023, 52 with a clear direction
...
- [Policing](/election/issues/policing) — 13 divided votes since 2023, 6 with a clear direction
