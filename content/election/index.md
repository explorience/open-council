...
These are the issues where council has actually split since 2023 — where a vote wasn't unanimous, and wasn't purely procedural. 1,133 additional divided motions since 2023 were independently classified as not fitting any of these tracked issue clusters, and are not force-fit into one; all of them are listed on the [issues page](/election/issues).

- [Housing & Density](/election/issues/housing) — 212 divided votes since 2023, 126 with a clear direction
- [Taxes & Budget](/election/issues/budget) — 127 divided votes since 2023, 85 with a clear direction
- [Homelessness & Encampments](/election/issues/encampments) — 115 divided votes since 2023, 53 with a clear direction
- [Transit & Roads](/election/issues/transit) — 59 divided votes since 2023, 29 with a clear direction
- [Climate & Green Space](/election/issues/climate) — 38 divided votes since 2023, 16 with a clear direction
- [Downtown & Core](/election/issues/downtown) — 20 divided votes since 2023, 12 with a clear direction
- [Bike Lanes / Cycling](/election/issues/bikes) — 16 divided votes since 2023, 11 with a clear direction
- [Policing](/election/issues/policing) — 12 divided votes since 2023, 6 with a clear direction
...
- [Elizabeth Peloza](/election/councillors/e-peloza) — Councillor
- [Hadleigh McAlister](/election/councillors/h-mcalister) — Councillor
- [Jerry Pribil](/election/councillors/j-pribil) — Councillor
- [Josh Morgan](/election/councillors/j-morgan) — Mayor
- [Paul Van Meerbergen](/election/councillors/p-van-meerbergen) — Councillor
- [Peter Cuddy](/election/councillors/p-cuddy) — Councillor
- [Sam Trosow](/election/councillors/s-trosow) — Councillor
- [Shawn Lewis](/election/councillors/s-lewis) — Councillor
- [Skylar Franke](/election/councillors/s-franke) — Councillor
- [Steve Hillier](/election/councillors/s-hillier) — Councillor
- [Steve Lehman](/election/councillors/s-lehman) — Councillor
- [Susan Stevenson](/election/councillors/s-stevenson) — Councillor

---

Methodology: A "divided" vote is any council or committee motion since January 1, 2023 that wasn't approved unanimously and wasn't a routine procedural step, and it doesn't include a vote decided by secret ballot to fill an appointment, since those don't produce a recorded yea or nay by councillor. Every motion's issue, axis, and direction ("what a yea did") come from an independent, motion-by-motion review, checked against that motion's own complete text in the official meeting record rather than a keyword search, with a small, separately published list of after-the-fact corrections applied on top — never a silent edit to the reviewed record. See the [issues page](/election/issues) for the exact counts and the unclassified/unclear disclosure.
